    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm pt-5'>
      ...
      <div>
        ...
        <div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-[#363636]">
          ...
          {
            isEdit ? <input className='bg-gray-50 max-w-52' type="text" onChange={(e) => setUserData(prev => ({ ...prev, name: e.target.value }))} value={userData.phone} /> : <p className='text-blue-500'>{userData.phone}</p>
          }
